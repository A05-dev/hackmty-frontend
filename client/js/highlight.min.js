var hljs = (function () {
  ...
  let r = (e) => !!e.scope || (e.sublanguage && e.language);
  class s {
    constructor(e, n) {
  ...
  let $ = "[a-zA-Z]\\w*",
    ...
    k = (e, n, t = {}) => {
      let a = i({ scope: "comment", begin: e, end: n, contains: [] }, t);
      a.contains.push({
        scope: "doctag",
  ...
  var A = Object.freeze({
    ...
    TITLE_MODE: { scope: "title", begin: $, relevance: 0 },
      ...
      ((e) => {
        if (Array.isArray(e.begin)) {
          ...
          if ("object" != typeof e.beginScope || null === e.beginScope)
            throw (F("beginScope must be object"), j);
      ...
      ((e) => {
        if (Array.isArray(e.end)) {
          ...
          if ("object" != typeof e.endScope || null === e.endScope)
            throw (F("endScope must be object"), j);
  ...
  var Q = ((n) => {
    ...
    function N(e, n, t) {
      ...
      "object" == typeof n
        ...
        : (P("10.7.0", "highlight(lang, code, ...args) has been deprecated."),
          P(
            "10.7.0",
          ...
          (a = n)),
        void 0 === t && (t = !0);
      let r = { code: a, language: i };
      z("before:highlight", r);
      let s = r.result ? r.result : w(r.language, r.code, t);
      return (s.code = r.code), z("after:highlight", s), s;
    }
    function w(e, n, r, s) {
      let c = Object.create(null);
      function g() {
        var e;
        if (!M.keywords) return void A.addText(C);
        let n = 0;
        M.keywordPatternRe.lastIndex = 0;
        let t = M.keywordPatternRe.exec(C),
          a = "";
        for (; t; ) {
          a += C.substring(n, t.index);
          ...
          if (r) {
            ...
            if (
              ...
              let o = N.classNameAliases[s] || s;
              A.addKeyword(t[0], o);
            }
          } else a += t[0];
          (n = M.keywordPatternRe.lastIndex), (t = M.keywordPatternRe.exec(C));
        }
        (a += C.substring(n)), A.addText(a);
      }
      function u() {
        null != M.subLanguage
          ? (() => {
              ...
              if ("string" == typeof M.subLanguage) {
                ...
                (e = w(M.subLanguage, C, !0, S[M.subLanguage])),
                  (S[M.subLanguage] = e._top);
              } else e = v(C, M.subLanguage.length ? M.subLanguage : null);
              M.relevance > 0 && (z += e.relevance),
      ...
      function b(e, n) {
        ...
        for (; t <= a; ) {
          ...
          let i = N.classNameAliases[e[t]] || e[t],
            r = n[t];
          i ? A.addKeyword(r, i) : ((C = r), g(), (C = "")), t++;
        }
      }
      function m(e, n) {
        return (
          ...
          e.beginScope &&
            (e.beginScope._wrap
              ? (A.addKeyword(
                ...
                (C = ""))
              : e.beginScope._multi && (b(e.beginScope, n), (C = ""))),
          (M = Object.create(e, { parent: { value: M } }))
        );
      }
      function p(e) {
        return 0 === M.matcher.regexIndex ? ((C += e[0]), 1) : ((j = !0), 0);
      }
      let f = {};
      function y(a, i) {
        let s = i && i[0];
        if (((C += a), null == s)) return u(), 0;
        if (
          "begin" === f.type &&
          "end" === i.type &&
          f.index === i.index &&
          ...
          if (((C += n.slice(i.index, i.index + 1)), !l)) {
            let o = Error(`0 width match regex (${e})`);
            throw ((o.languageName = e), (o.badRule = f.rule), o);
          }
          return 1;
        }
        if (((f = i), "begin" === i.type))
          return ((e) => {
            ...
            for (let s of r) if (s && (s(e, i), i.isMatchIgnored)) return p(n);
            return (
              a.skip
                ? (C += n)
                : (a.excludeBegin && (C += n),
                  u(),
                  a.returnBegin || a.excludeBegin || (C = n)),
              m(a, e),
            ...
            let i = a[0],
              ...
              s = (function e(n, a, i) {
                ...
                if (r) {
                  if (n["on:end"]) {
                    let s = new t(n);
                    n["on:end"](a, s), s.isMatchIgnored && (r = !1);
                  }
                  if (r) {
                ...
                if (n.endsWithParent) return e(n.parent, a, i);
              })(M, a, r);
            if (!s) return W;
            let l = M;
            M.endScope && M.endScope._wrap
              ? (u(), A.addKeyword(i, M.endScope._wrap))
              : M.endScope && M.endScope._multi
              ? (u(), b(M.endScope, a))
              : l.skip
              ? (C += i)
              : (l.returnEnd || l.excludeEnd || (C += i),
                u(),
                l.excludeEnd && (C = i));
            do
              M.scope && A.closeNode(),
                M.skip || M.subLanguage || (z += M.relevance),
                (M = M.parent);
            while (M !== s.parent);
            return s.starts && m(s.starts, a), l.returnEnd ? 0 : i.length;
          })(i);
          if (d !== W) return d;
        }
        if ("illegal" === i.type && "" === s) return 1;
        if (P > 1e5 && P > 3 * i.index)
          throw Error(
      ...
      let N = O(e);
      if (!N)
        throw (F(o.replace("{}", e)), Error('Unknown language: "' + e + '"'));
      let x = (function e(n) {
          function t(e, t) {
            return RegExp(
              d(e),
          ...
          return (
            (n.classNameAliases = i(n.classNameAliases || {})),
            (function e(a, s) {
              let l = a;
              if (a.isCompiled) return l;
              [T, I, q, B].forEach((e) => e(a, s)),
                n.compilerExtensions.forEach((e) => e(a, s)),
                (a.__beforeBegin = null),
                [R, D, L].forEach((e) => e(a, s)),
                (a.isCompiled = !0);
              let o = null;
              return (
                "object" == typeof a.keywords &&
                  ...
                  (o = a.keywords.$pattern),
                  delete a.keywords.$pattern),
                (o = o || /\w+/),
                a.keywords &&
                  (a.keywords = (function e(n, t, a = "keyword") {
                      ...
                      t && (n = n.map((e) => e.toLowerCase())),
                        n.forEach((n) => {
                          ...
                          i[s[0]] = [
                            ...
                            a
                              ? Number(a)
                              : ((r = t), _.includes(r.toLowerCase()))
                              ? 0
                              : 1),
                          ];
                        });
                    }
                  })(a.keywords, n.case_insensitive)),
                (l.keywordPatternRe = t(o, !0)),
                s &&
                  (a.begin || (a.begin = /\B|\b/),
                  (l.beginRe = t(l.begin)),
                  a.end || a.endsWithParent || (a.end = /\B|\b/),
                  a.end && (l.endRe = t(l.end)),
                  (l.terminatorEnd = d(l.end) || ""),
                  a.endsWithParent &&
                    s.terminatorEnd &&
                    (l.terminatorEnd += (a.end ? "|" : "") + s.terminatorEnd)),
                a.illegal && (l.illegalRe = t(a.illegal)),
                a.contains || (a.contains = []),
                (a.contains = [].concat(
                  ...a.contains.map((e) => {
                    var n;
                    return (
                      (n = "self" === e ? a : e).variants &&
                        !n.cachedVariants &&
                        (n.cachedVariants = n.variants.map((e) =>
                          i(n, { variants: null }, e)
                        )),
                      n.cachedVariants
                        ? n.cachedVariants
                ...
                a.contains.forEach((n) => {
                  e(n, l);
                }),
                a.starts && e(a.starts, s),
                (l.matcher = ((e) => {
                  let n = new r();
                  return (
      ...
      try {
        for (M.matcher.considerAll(); ; ) {
          P++,
            j ? (j = !1) : M.matcher.considerAll(),
            (M.matcher.lastIndex = U);
          let K = M.matcher.exec(n);
          if (!K) break;
          let H = y(n.substring(U, K.index), K);
          U = K.index + H;
        }
        return (
          y(n.substring(U)),
    ...
    function x(e) {
      let n = null,
        t = ((e) => {
          ...
          return n.split(/\s+/).find((e) => y(e) || O(e));
        })(e);
      if (y(t)) return;
      if (
        (z("before:highlightElement", { el: e, language: t }),
        e.children.length > 0 &&
          ($.ignoreUnescapedHTML || $.throwUnescapedHTML))
      )
        throw new H(
      ...
      n = e;
      let a = n.textContent,
        i = t ? N(a, { language: t, ignoreIllegals: !0 }) : v(a);
      (e.innerHTML = i.value),
        ((e, n, t) => {
          let a = (n && r[n]) || t;
        ...
        z("after:highlightElement", { el: e, result: i, text: a });
    }
    let k = !1;
    function M() {
    ...
    function O(e) {
      return a[(e = (e || "").toLowerCase())] || a[r[e]];
    }
    function S(e, { languageName: n }) {
      "string" == typeof e && (e = [e]),
        e.forEach((e) => {
          r[e.toLowerCase()] = n;
        });
    ...
    for (let j in ("undefined" != typeof window &&
    ...
    Object.assign(n, {
      ...
      highlightElement: x,
      highlightBlock: (e) => (
        P("10.7.0", "highlightBlock will be removed entirely in v12.0"),
        P("10.7.0", "Please use highlightElement now."),
        x(e)
      ),
      configure(e) {
        $ = G($, e);
      ...
      registerLanguage(e, t) {
        ...
        i.name || (i.name = e),
          ...
          i.aliases && S(i.aliases, { languageName: e });
      },
      unregisterLanguage(e) {
        for (let n of (delete a[e], Object.keys(r))) r[n] === e && delete r[n];
      },
    ...
    A))
      "object" == typeof A[j] && e.exports(A[j]);
  ...
  let X = (e) => ({
    ...
    et = Y.concat(ee);
  var ea = "\\.([0-9](_*[0-9])*)",
    ei = "[0-9a-fA-F](_*[0-9a-fA-F])*",
    er = {
      className: "number",
      variants: [
        {
          begin: `(\\b([0-9](_*[0-9])*)((${ea})|\\.)?|(${ea}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`,
        },
        { begin: `\\b([0-9](_*[0-9])*)((${ea})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
        { begin: `(${ea})[fFdD]?\\b` },
        { begin: "\\b([0-9](_*[0-9])*)[fFdD]\\b" },
        {
          begin: `\\b0[xX]((${ei})\\.?|(${ei})?\\.(${ei}))[pP][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`,
        },
  ...
  let es = "[A-Za-z$_][0-9A-Za-z$_]*",
    ...
    eo = ["true", "false", "null", "undefined", "NaN", "Infinity"],
    ec = [
      "Object",
      "Function",
      "Boolean",
  ...
  function em(e) {
    ...
    let p = [].concat(b, c.contains),
      ...
      y = {
        match: t.concat(
          /\b/,
          ((n = [...eg, "super", "import"]), t.concat("(?!", n.join("|"), ")")),
          a,
          t.lookahead(/\(/)
        ),
    ...
    return {
      ...
      keywords: r,
      exports: { PARAMS_CONTAINS: h, CLASS_REFERENCE: $ },
      illegal: /#(?![$_A-z])/,
      contains: [
  ...
  let ep = (e) => m(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
    e8 = ["Protocol", "Type"].map(ep),
    eh = ["init", "self"].map(ep),
    ef = ["Any", "Self"],
    eE = [
      "actor",
  ...
  var eR = Object.freeze({
    ...
    grmr_c(e) {
      let n = e.regex,
        ...
        u = [o, r, t, e.C_BLOCK_COMMENT_MODE, l, s],
        b = {
          variants: [
            { begin: /=/, end: /;/ },
            { begin: /\(/, end: /\)/ },
            ...
            { relevance: 0, match: /,/ },
            {
              ...
              contains: [
                ...
                r,
                {
                  ...
                  keywords: g,
                  relevance: 0,
                  contains: ["self", t, e.C_BLOCK_COMMENT_MODE, s, l, r],
                },
              ],
            },
            r,
      ...
      return {
        ...
        exports: { preprocessor: o, strings: s, keywords: g },
      };
    },
    grmr_cpp(e) {
      let n = e.regex,
        ...
        b = [u, o, r, t, e.C_BLOCK_COMMENT_MODE, l, s],
        m = {
          variants: [
            { begin: /=/, end: /;/ },
            { begin: /\(/, end: /\)/ },
    ...
    grmr_csharp(e) {
      ...
      let g = { variants: [c, o, i, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE] },
        u = {
          begin: "<",
          end: ">",
    ...
    grmr_css(e) {
      ...
      return {
        ...
        contains: [
          ...
          t.CSS_VARIABLE,
          { className: "attribute", begin: "\\b(" + en.join("|") + ")\\b" },
          {
            begin: /:/,
            end: /[;}{]/,
            contains: [
          ...
          { className: "selector-tag", begin: "\\b(" + V.join("|") + ")\\b" },
        ],
      };
    },
    grmr_diff(e) {
    ...
    grmr_java(e) {
      let n = e.regex,
        ...
        a =
          t +
          (function e(n, t, a) {
            return -1 === a ? "" : n.replace(t, (i) => e(n, t, a - 1));
          })("(?:<" + t + "~~~(?:\\s*,\\s*" + t + "~~~)*>)?", /~~~/g, 2),
        i = {
          keyword: [
            "synchronized",
    ...
    grmr_less(e) {
      let n = X(e),
        ...
        a = [],
        i = [],
        r = (e) => ({ className: "string", begin: "~?" + e + ".*?" + e }),
        s = (e, n, t) => ({ className: e, begin: n, relevance: t }),
        l = {
          $pattern: /[a-z-]+/,
          keyword: "and or not only",
          attribute: J.join(" "),
      ...
      i.push(
        ...
        n.HEXCOLOR,
        { begin: "\\(", end: "\\)", contains: i, keywords: l, relevance: 0 },
        s("variable", "@@?[\\w-]+", 10),
        s("variable", "@\\{[\\w-]+\\}"),
        s("built_in", "~?`[^`]*?`"),
        {
      ...
      let o = i.concat({ begin: /\{/, end: /\}/, contains: a }),
        c = {
          beginKeywords: "when",
          endsWithParent: !0,
      ...
      return {
        ...
        contains: [
          ...
          { className: "tag", begin: /<>|<\/>/ },
          {
            ...
            contains: [
              { className: "name", begin: t, relevance: 0, starts: o },
            ],
          },
          {
            className: "tag",
          ...
          contains: [
            {
              className: "section",
              variants: [
                { begin: "^#{1,6}", end: "$", contains: (l = l.concat(a, i)) },
                {
                  begin: "(?=^.+?\\n[=-]{2,}$)",
                  contains: [
                    { begin: "^[=-]*$" },
          ...
          },
          {
            ...
            contains: [
              e.HASH_COMMENT_MODE,
              {
                className: "regexp",
                variants: [
                  { begin: c("s|tr|y", n.either(...o, { capture: !0 })) },
                  { begin: c("s|tr|y", "\\(", "\\)") },
                  { begin: c("s|tr|y", "\\[", "\\]") },
                  { begin: c("s|tr|y", "\\{", "\\}") },
                ],
              ...
              },
              {
                ...
                variants: [
                  ...
                  { begin: d("(?:m|qr)?", /\//, /\//) },
                  { begin: d("m|qr", n.either(...o, { capture: !0 }), /\1/) },
                  { begin: d("m|qr", /\(/, /\)/) },
                  { begin: d("m|qr", /\[/, /\]/) },
                  { begin: d("m|qr", /\{/, /\}/) },
                ],
    ...
    grmr_php(e) {
      let n = e.regex,
        ...
        y = {
          ...
          keywords: m,
          contains: [$, r, E, e.C_BLOCK_COMMENT_MODE, c, d, h],
        },
        N = {
          relevance: 0,
          match: [
      ...
      y.contains.push(N);
      let w = [$, E, e.C_BLOCK_COMMENT_MODE, c, d, h];
      return {
        case_insensitive: !1,
        keywords: m,
        contains: [
        ...
        o = {
          ...
          variants: [
            ...
            },
            {
              ...
              contains: [e.BACKSLASH_ESCAPE, r, l, s],
            },
            {
              begin: /([fF][rR]|[rR][fF]|[fF])"""/,
              end: /"""/,
        ...
        m = {
          ...
          variants: [
            { className: "", begin: /\(\s*\)/, skip: !0 },
            {
              ...
              excludeEnd: !0,
              keywords: i,
              contains: ["self", r, u, o, e.HASH_COMMENT_MODE],
            },
          ],
        };
      return (
      ...
      return {
        ...
        contains: [
          ...
          },
          {
            ...
            keywords: { $pattern: t, keyword: "@page @font-face" },
          },
          {
            begin: "@",
            end: "[{;]",
    ...
    grmr_swift(e) {
      let n = { match: /\s+/, relevance: 0 },
        ...
        i = { match: [/\./, p(...e8, ...eh)], className: { 2: "keyword" } },
        r = { match: m(/\./, p(...eE)), relevance: 0 },
        s = eE.filter((e) => "string" == typeof e).concat(["_|0"]),
        l = {
          variants: [
            {
              className: "keyword",
        ...
        c = [i, r, l],
        d = [
          { match: m(/\./, p(...ew)), relevance: 0 },
          { className: "built_in", match: m(/\b/, p(...ew), /(?=\()/) },
        ],
        u = { match: /->/, relevance: 0 },
        b = [
          u,
        ...
        M = [
          ...
          { className: "keyword", match: m(/@/, p(...eC)) },
          { className: "meta", match: m(/@/, eS) },
        ],
        O = {
          match: g(/\b[A-Z]/),
          relevance: 0,
          contains: [
            ...
            { className: "type", match: eA, relevance: 0 },
            { match: /[?!]+/, relevance: 0 },
            { match: /\.\.\./, relevance: 0 },
            { match: m(/\s+&\s+/, g(eA)), relevance: 0 },
          ],
        };
      O.contains.push({
        begin: /</,
      ...
      let S = {
          ...
          contains: [
            "self",
            { match: m(eS, /\s*:/), keywords: "_|0", relevance: 0 },
            ...a,
            ...c,
            ...d,
            ...b,
        ...
        C = {
          ...
          contains: [
            {
              begin: p(g(m(eS, /\s*:/)), g(m(eS, /\s+/, eS, /\s*:/))),
              end: /:/,
              relevance: 0,
              contains: [
                { className: "keyword", match: /\b_\b/ },
                { className: "params", match: eS },
              ],
            },
            ...a,
            ...c,
        ...
        T = {
          match: [/func/, /\s+/, p(x.match, eS, ek)],
          className: { 1: "keyword", 3: "title.function" },
          contains: [A, C, n],
          illegal: [/\[/, /%/],
        };
      for (let R of v.variants) {
        let D = R.contains.find((e) => "interpol" === e.label);
        D.keywords = o;
        let I = [...c, ...d, ...b, f, v, ...k];
        D.contains = [
          ...I,
    ...
    grmr_typescript(e) {
      let n = em(e),
        ...
        r = {
          ...
          literal: eo,
          built_in: eb.concat(t),
          "variable.language": eu,
        },
        s = { className: "meta", begin: "@[A-Za-z$_][0-9A-Za-z$_]*" },
        l = (e, n, t) => {
          let a = e.contains.findIndex((e) => e.label === n);
  ...
  let eD = Q;
  for (let eI of Object.keys(eR)) {
    let eL = eI.replace("grmr_", "").replace("_", "-");
    eD.registerLanguage(eL, eR[eI]);
  }
  return eD;
})();
